import Nur from "../assets/nur.webp";
import Kana from "../assets/kaana.webp";

function Contact() {
  return (
    <>
      <div className="flex flex-col justify-center bg-gray-900 min-h-screen text-white font-bold p-5 gap-5">
        <h1 className="text-4xl text-center">Kontak Kami</h1>
        <article className="bg-amber-400 container_contact shadow-amber-400/50">
          <img src={Nur} alt="Nur" width="30%" className="img_contact" />
        ...
        <article className="bg-blue-400 container_contact shadow-blue-400/50">
          <img src={Kana} alt="Kana" width="30%" className="img_contact" />
          <div className="flex flex-col gap-2">
            <p>Kana</p>
            <h1>Backend</h1>
          </div>
